          ...
          <div className="grid-container">
            <div className="featured grid-one">
              <Link to="categories/football">
                ...
                <p className="main-description">Football</p>
              </Link>
            </div>
            <div className="featured grid-two">
              <Link to="categories/cricket">
                ...
                <p className="main-description">Cricket</p>
              </Link>
            </div>
            <div className="featured grid-four">
              <Link to="categories/running">
                <div id="img3" className="lil-overlay"></div>
                <img src={Main3} alt="img3" />
                <p className="main-description">Running</p>
              </Link>
            </div>
            <div className="featured grid-four-low">
              <Link to="categories/basketball">
                <div id="img4" className="lil-overlay"></div>
                <img src={Main4} alt="img4" />
                <p className="main-description">Basketball</p>
              </Link>
            </div>
          </div>
        </div>
